...
description: The Plain Elastic License -- the Elastic License, but now in plainer language for everyone to understand. Real terms for real people.
spdx_id: Elastic-2.0
original_name: Elastic License 2.0
original_url: https://www.elastic.co/licensing/elastic-license
...
/// details | **Thanks Elastic!** for providing clear terms. **You rock!** :heart:
    type: note
...
2. *Delayed permissive* licenses like the Functional Source License (FSL), which forbids competitors from offering the work as a service for a 2-4 year period (2 years for FSL). After that period, the work becomes permissively licensed (e.g., MIT, Apache 2.0). For everyone else, the work is permissively licensed from the start.
